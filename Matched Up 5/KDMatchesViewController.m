...
#import "KDMatchesViewController.h"
#import "KDChatViewController.h"

@interface KDMatchesViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation KDMatchesViewController
...
{
    KDChatViewController *chatVC = segue.destinationViewController;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = likedUser[@"profile"][@"firstNameKey"];
